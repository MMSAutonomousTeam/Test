...
bool letters_drawing_2__msg__turtle_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("letters_drawing_2.msg._turtle_info.TurtleInfo", full_classname_dest, 45) == 0);
  }
  letters_drawing_2__msg__TurtleInfo * ros_message = _ros_message;
  {  // turtle_name
  ...
  {  // target_coords
    PyObject * field = PyObject_GetAttrString(_pymsg, "target_coords");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->target_coords)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of TurtleInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("letters_drawing_2.msg._turtle_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TurtleInfo");
  ...
  {  // target_coords
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->target_coords);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "target_coords", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
